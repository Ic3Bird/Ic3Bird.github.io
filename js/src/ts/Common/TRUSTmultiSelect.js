define(["require", "exports"], function (require, exports) {
    ...
    function createSearchBox() {
        ...
        SearchBox.setAttribute("onkeyup", "search(this);");
    ...
    function createSelectAllBox() {
        ...
        if (!(BIsSingelSelect || IsSelectDisable(BOriginalObjectID))) {
            selectAllButton.setAttribute("onclick", "selectAllSearchResult(this);");
        }
        ...
        if (!(BIsSingelSelect || IsSelectDisable(BOriginalObjectID))) {
            clearAllButton.setAttribute("onclick", "clearAll(this);");
        }
    ...
    function createSelectionRow(POriginalID, RowID, LabelText, PIsSelected) {
        ...
        checkbox.setAttribute("onclick", "changeRowSelection_Main(this);");
